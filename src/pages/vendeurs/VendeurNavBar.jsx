...
const Header = ({ sidebarToggle, setSidebarToggle }) => {
  ...
  return (
    <nav className="bg-blue-500 px-4 py-3 flex justify-between items-center">
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="relative hidden md:flex items-center">
          ...
          <input className="w-64 pl-5 pr-4 py-1 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
            // type="text"
            placeholder="Search..."
          />
        </div>
